...
INSERT INTO aurora.entity_entries (id, created_at, updated_at, description, name, public_name, type, entity_id, farm_id, code) VALUES (5, '2020-03-15 14:18:40', '2020-03-15 14:18:40', 'Status do produto', 'status', 'Status', 3, 3, 2, 'adas98d');
INSERT INTO aurora.entity_entries (id, created_at, updated_at, description, name, public_name, type, entity_id, farm_id, code) VALUES (6, '2020-03-23 21:30:55', '2020-03-23 21:30:57', 'Nome do produto', 'name', 'Nome', 0, 3, 2, 'asd09a');
INSERT INTO aurora.entity_entries (id, created_at, updated_at, description, name, public_name, type, entity_id, farm_id, code) VALUES (7, '2020-03-23 21:32:39', '2020-03-23 21:32:42', 'Codigo do produto', 'code', 'Codigo', 0, 3, 2, '56asd5sa');
...
INSERT INTO aurora.table_config_actions (id, created_at, updated_at, btn_type, icon, link, text, config_group_id, code) VALUES (12, '2020-03-27 19:37:46', '2020-03-27 19:37:48', 'btn btn-sm btn-link', 'plus', '/tab/product', 'Add new', 11, 'ad98asd');
